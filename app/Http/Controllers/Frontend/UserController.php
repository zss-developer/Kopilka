...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->view('pages.user.index', [
            'view'      => 'pages.user.settings.general',
            'user'      => $user,
        ]);
    }
    ...
    public function settingsSecurity(Request $request)
    {
        ...
        return response()->view('pages.user.index', [
            'view' => 'pages.user.settings.security',
            'user' => $user,
        ]);
    }
	...
	public function settingsContacts(Request $request)
    {
        ...
        return response()->view('pages.user.index', [
            'view'      => 'pages.user.settings.contacts',
            'user'      => $user,
            'countries'     => $countries,
        ]);
    }
	...
	public function settingsNotifications(Request $request)
	{
		...
		return response()->view('pages.user.index', [
			'view' => 'pages.user.settings.notify',
			'user' => $user
		]);
	}
	 ...
	 * @return \Illuminate\Http\Response
	 */
	public function settingsIntegrations(Request $request)
	{

		$user = Auth::user();

		return response()->view('pages.user.index', [
			'view' => 'pages.user.settings.integrations',
			'user' => $user
		]);
	}
}
