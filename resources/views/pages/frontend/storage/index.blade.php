...
@push('styles')
    <link rel="stylesheet" type="text/css" href="{{secure_asset('/libs/select2/css/select2.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{secure_asset('/libs/select2/css/select2.custom.min.css')}}">
    <style>
        .ks-title {
...
@push('scripts')
    <script src="{{secure_asset('/libs/select2/js/select2.js')}}"></script>
